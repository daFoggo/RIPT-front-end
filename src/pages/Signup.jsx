                ...
                <div className="flex shadow-lg max-w-3xl p-5 rounded-xl bg-gradient-to-r from-[#f0f7ff] to-[#e0eefe]">
                    ...
                    <div className="px-8">
                        ...
                        <p className="text-sm mt-4 text-[#0a175c]">
                            Cổng đăng kí phòng Công Nghệ Số
                        </p>
                        ...
                        <form action="" className="flex flex-col gap-4">
                            ...
                            />
                            <input
                                className="p-2 rounded-xl border border-blue-200 text-sm"
                                type="text"
                                name="phone"
                            ...
                            <div className="flex justify-between">
                                <input
                                    className="p-2 rounded-xl border border-blue-200 text-sm flex-1 mr-1"
                                    type="date"
                                />
                                <select
                                    className="p-2 rounded-xl border border-blue-200 text-sm flex-1 ml-1 bg-white"
                                    name="role"
                                    id="selectRole"
                                >
                            ...
                            <Link to="/login">
                                <div className="flex">
                                    <button className="bg-[#2f61ff] rounded-xl flex-1 text-white py-2 hover:scale-105 hover:bg-[#0c30ff] duration-300">
                                        Đăng kí
                                    </button>
                                </div>
                            </Link>
