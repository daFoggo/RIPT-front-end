        ...
        <div className="flex shadow-lg max-w-3xl p-5 rounded-xl bg-gradient-to-r from-[#f0f7ff] to-[#e0eefe]">
          ...
          <div className="sm:w-1/2 px-8">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-fill absolute top-1/2 right-3 -translate-y-1/2" viewBox="0 0 16 16">
                    {!showPassword ? (
                      ...
                      <>
                        ...
                        <path d="M11.297 9.176a3.5 3.5 0 0 0-4.474-4.474l.823.823a2.5 2.5 0 0 1 2.829 2.829zm-2.943 1.299.822.822a3.5 3.5 0 0 1-4.474-4.474l.823.823a2.5 2.5 0 0 0 2.829 2.829" onClick={handleSetShowPassword} />
            ...
            <div className="mt-5 text-xs flex justify-between border-t-2 py-4 items-center">
              ...
              <Link to="/signup">
                <button className="py-2 px-5 rounded-md border border-blue-500 bg-[#2f61ff] hover:bg-[#0c30ff] text-white text- hover:scale-105 duration-300">Đăng kí</button>
              </Link>
            </div>
          ...
          <div className="w-1/2 p sm:block hidden">
            <img className="rounded-xl" src="src\assets\imgs\sinhvien1 copy.jpg" alt="" />
          </div>
        </div>
      </section>
    </div>
