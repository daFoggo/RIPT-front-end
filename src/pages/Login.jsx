    ...
    if (email === "" || password === "") {
      ...
      try {
        const response = await axios.post(
          "http://172.16.8.81:8017/web/session/authenticate",
          {
            "jsonrpc": "2.0",
            "params": {
              "db": "namnam",
      ...
      <section className="min-h-screen flex items-center justify-center backdrop-blur-sm">
        <div className="flex shadow-lg max-w-3xl p-5 rounded-xl bg-gradient-to-r from-[#f0f7ff] to-[#e0eefe]">
          ...
          <div className="sm:w-1/2 px-8 flex flex-col justify-between">
            <div>
              <h2 className="text-xl text-[#0a175c]">PHÒNG CÔNG NGHỆ SỐ</h2>
              <p className="text-md mt-1 text-[#0a175c]">
                Đăng nhập
              </p>
              ...
              <div className="flex flex-col gap-4 mt-5 select-none">
                ...
                <div className="relative">
                  ...
                  />
                  <div onClick={handleSetShowPassword} className="cursor-pointer">
                    <svg
            ...
            <div>
              <a
                href="https://ript.vn/"
                className=" text-sm flex items-center justify-center gap-3 mt-20"
              >
                <p className="text-[#0a175c] mt-0">
