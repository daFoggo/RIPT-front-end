      ...
      <div className="infoCard bg-[#eff7ff] rounded-xl flex flex-col items-center w-1/3 p-8 mr-4">
        <div className="flex flex-col">
          <div className="relative">
            <img
              className="w-52 h-52 rounded-full bg-cover border-4 border-[#bed5fd] hover:brightness-105"
              src={avatarUrl.current}
              alt=""
              onClick={handleSetAvatarModal}
            />
            <div
              className="absolute -bottom-[0.6rem] left-[5.6rem] bg-[#eff7ff] rounded-full border-[#bed5fd] border-2 p-1 cursor-pointer"
              onClick={handleSetAvatarModal}
            >
              <svg
      ...
      <div className="infoForm bg-[#eff7ff] w-full rounded-xl p-4 flex flex-col gap-5">
        ...
        >
          ...
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-pencil-square hover:scale-110 duration-300"
            viewBox="0 0 16 16"
          >
        ...
        <form
          className="border-2 border-[#e2edfe] rounded-md py-4 px-4 flex flex-col"
          action=""
        >
        ...
        <div
          className="self-end cursor-pointer"
          onClick={handleSetModifyPasswordModal}
        >
          <button className="bg-[#172754] text-white rounded-md py-1 px-2 hover:bg-[#2c4383] hover:text-[white] hover:scale-105 duration-300">
            Đổi mật khẩu
          </button>
        </div>
      </div>
