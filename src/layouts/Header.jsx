            ...
            <div className="flex justify-between mb-12 border-b-2 pb-3">
                ...
                <div>
                    <div className="user-and-not flex justify-end items-center">
                        ...
                        <div ref={userRef}>
                            <div
                                className="user flex justify-between border-l-2 pl-3 cursor-pointer"
                                onClick={handleSetUserDropDown}
                            >
                                <div className="avatar mr-4">
                                    <img
                                        className="w-10 h-10 p-1 rounded-full ring-2 ring-[#172754] dark:ring-[#172754]"
                            ...
                            {userDropDown && (
                                <UserDropDown
                                    className="active"
                                    onSetUserDropDown={handleSetUserDropDown}
                                />
                            )}
                        </div>
                    </div>
