        ...
        <nav className="h-dvh w-full">
            <div className="navBar flex flex-col pl-5 pt-3">
                ...
                <div className="links flex flex-col mt-12">
                    <div
                        href=""
                        className="mb-8 flex items-center hover:bg-[#d2e7fe] hover:text-[#1e3e8a] duration-200 p-1 rounded"
                    >
                        <svg
                    ...
                    <div
                        ...
                        onClick={handleSetCalendarActive}
                    >
                        <div
                            href=""
                            className={`calendar flex items-center hover:text-[#1e3e8a] hover:bg-[#d2e7fe] duration-200 p-1 rounded ${calendarActive ? "active" : "inactive"
                                }`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        href=""
                        className="flex items-center hover:bg-[#d2e7fe] hover:text-[#1e3e8a] duration-200 p-1 rounded"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
